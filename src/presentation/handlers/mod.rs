...
pub fn handle_key(app: &mut AppState, key: KeyEvent) {
    if let Some(ActivePopup::PlanApproval { focus, feedback_buffer, feedback_cursor, .. }) = &mut app.active_popup {
        match key.code {
            ...
            KeyCode::Enter => {
                match *focus {
                    ...
                    PlanApprovalFocus::Feedback => {
                        if let Some(ActivePopup::PlanApproval { responder, feedback_buffer, .. }) = app.active_popup.take() {
